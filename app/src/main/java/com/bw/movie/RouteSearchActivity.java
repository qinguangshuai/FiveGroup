...
import com.bw.movie.mymap.BusRouteOverlay;
import com.bw.movie.mymap.DrivingRouteOverlay;
import com.bw.movie.mymap.RideRouteOverlay;
import com.bw.movie.mymap.WalkRouteOverlay;
...
public class RouteSearchActivity extends AppCompatActivity implements RouteSearch.OnRouteSearchListener,View.OnClickListener {
    ...
    private void setRouteCarListener(int type) {
        ...
        //模拟起始点与目的经纬度（如：深圳市）
        double latitude = MapActivity.latitude;
        double longitude1 = MapActivity.longitude1;
        RouteSearch.FromAndTo fromAndTo = new RouteSearch.FromAndTo(new LatLonPoint(latitude, longitude1),
                new LatLonPoint(latitude, longitude1));
