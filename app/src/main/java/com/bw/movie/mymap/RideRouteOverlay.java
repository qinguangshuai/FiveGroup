...
/**
 * date:2019/1/18    18:32
 * author:Therefore(Lenovo)
 * fileName:RideRouteOverlay
 */
public class RideRouteOverlay extends com.bw.movie.mymap.RouteOverlay {
    ...
    private void initPolylineOptions() {
        ...
        if(walkStationDescriptor == null) {
            walkStationDescriptor = BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher);
        }
